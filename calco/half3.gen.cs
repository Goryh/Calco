...
namespace calco
{
    ...
    public static class half3c
    {
        public static half3 zero      { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => new((half)0); }
    }
    ...
    public partial struct half3 : System.IEquatable<half3>, IFormattable
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly bool Equals(half3 rhs) { return x == rhs.x && y == rhs.y && z == rhs.z; }

        /// <summary>Returns true if the half3 is equal to a given half3, false otherwise.</summary>
        /// <param name="o">Right hand side argument to compare equality with.</param>
        /// <returns>The result of the equality comparison.</returns>
        public readonly override bool Equals(object o) { return o is half3 converted && Equals(converted); }
