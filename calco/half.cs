...
namespace calco
{
    ...
    {
        public static half zero      { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => new(0); }
    }
    ...
    public struct half : System.IEquatable<half>, IFormattable
    {
        ...
        /// </summary>
        public static float MaxValue { [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return 65504.0f; } }

        /// <summary>
        /// The minimum finite half value as a single precision float.
        /// </summary>
        public static float MinValue { [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return -65504.0f; } }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly bool Equals(half rhs) { return value == rhs.value; }
        ...
        public readonly override bool Equals(object o) { return o is half converted && Equals(converted); }

        /// <summary>Returns a hash code for the half.</summary>
        /// <returns>The computed hash code of the half.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly override int GetHashCode() { return (int)value; }
