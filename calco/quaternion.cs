...
namespace calco
{
    ...
    public static class quaternionc
    {
		...
		public static quaternion rotateXn90	{ [MethodImpl(MethodImplOptions.AggressiveInlining)] get => new(-0.70710678f, 0.0f, 0.0f, 0.70710678f); }
		...
		public static quaternion rotateYn90	{ [MethodImpl(MethodImplOptions.AggressiveInlining)] get => new(0.0f, -0.70710678f, 0.0f, 0.70710678f); }
		...
		public static quaternion rotateZn90	{ [MethodImpl(MethodImplOptions.AggressiveInlining)] get => new(0.0f, 0.0f, -0.70710678f, 0.70710678f); }
