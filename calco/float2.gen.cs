...
namespace Unity.Mathematics
{
    ...
    {
        public static float2 zero      { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => new(0); }
        public static float2 one       { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => new(1); }
    }
    ...
    public partial struct float2 : System.IEquatable<float2>, IFormattable
    {
        ...
        public float2(half2 v):
            this(math.f16tof32(math.ushort2(v.x.value, v.y.value)))
        {
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float2 operator - (in float2 val) { return new float2 (-val.x, -val.y); }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        public readonly float2 ComplexMultiply(in float2 b)
        {
            float aRe = x, bRe = b.x;
            float aIm = y, bIm = b.y;
            return new float2(aRe * bRe - aIm * bIm, 
                              aRe * bIm + aIm * bRe);
        }

        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        public readonly float2 ComplexMultiply(in float b)
        {
            float aRe = x;
            float aIm = y;
            return new float2(aRe * b, aIm * b);
        }

        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        public readonly float2 ComplexDivide(in float2 b)
        {
            float aRe = x, bRe = b.x;
            float aIm = y, bIm = b.y;
            float modulusSquared = bRe * bRe + bIm * bIm;

            return new float2(aRe * bRe + aIm * bIm,
                              aIm * bRe - aRe * bIm) / modulusSquared;
        }

        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        public readonly float2 ComplexDivide(in float b)
        {
            float aRe = x;
            float aIm = y;
            return new float2(aRe / b, aIm / b);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly bool Equals(float2 rhs) { return x == rhs.x && y == rhs.y; }

        /// <summary>Returns true if the float2 is equal to a given float2, false otherwise.</summary>
        /// <param name="o">Right hand side argument to compare equality with.</param>
        /// <returns>The result of the equality comparison.</returns>
        public readonly override bool Equals(object o) { return o is float2 converted && Equals(converted); }
        ...
        internal sealed class DebuggerProxy
        {
            public float x;
            public float y;
            public DebuggerProxy(in float2 v)
            {
                x = v.x;
                y = v.y;
            }
    ...
    public static partial class math
    {
        ...
        /// <returns>float2 constructed from arguments.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float2 float2(in float2 xy) { return new float2(xy); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint hash(in float2 v)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint2 hashwide(in float2 v)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float shuffle(in float2 a, in float2 b, ShuffleComponent x)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float2 shuffle(in float2 a, in float2 b, ShuffleComponent x, ShuffleComponent y)
        {
            return float2(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float3 shuffle(in float2 a, in float2 b, ShuffleComponent x, ShuffleComponent y, ShuffleComponent z)
        {
            return float3(
                select_shuffle_component(a, b, x),
                select_shuffle_component(a, b, y),
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float4 shuffle(in float2 a, in float2 b, ShuffleComponent x, ShuffleComponent y, ShuffleComponent z, ShuffleComponent w)
        {
            return float4(
                select_shuffle_component(a, b, x),
                select_shuffle_component(a, b, y),
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static float select_shuffle_component(in float2 a, in float2 b, ShuffleComponent component)
        {
            switch(component)
            {
