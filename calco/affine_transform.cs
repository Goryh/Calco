...
namespace Unity.Mathematics
{
    ...
    {
        public static readonly AffineTransform identity = new AffineTransform(float3c.zero, float3x3.identity);
    }
    ...
    public struct AffineTransform : IEquatable<AffineTransform>, IFormattable
    {
        ...
        public float3a ta { [MethodImpl(MethodImplOptions.AggressiveInlining)] readonly get => float3a(t);
                            [MethodImpl(MethodImplOptions.AggressiveInlining)] set {t = value;} }
    ...
    public static partial class math
    {
        ...
        /// <returns>The AffineTransform of a transforming b.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AffineTransform mul(float3ax3 a, AffineTransform b)
        {
        ...
        /// <returns>The AffineTransform of a transforming b.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AffineTransform mul(AffineTransform a, float3ax3 b)
        {
        ...
        {
            return float4(mul(a.rs, pos.xyza) + a.ta * pos.w, pos.w);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float3a rotate(AffineTransform a, float3a dir)
        {
            return mul(a.rs, dir);
        }
        ...
        /// <returns>The transformed position.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float3a transform(AffineTransform a, float3a pos)
        {
            return a.ta + mul(a.rs, pos);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void decompose(AffineTransform a, out float3a translation, out quaternion rotation, out float3a scale)
        {
            translation = a.t;
