...
namespace calco
{
    ...
    public static class half2c
    {
        public static half2 zero      { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => new((half)0); }
    }
    ...
    public partial struct half2 : System.IEquatable<half2>, IFormattable
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly bool Equals(half2 rhs) { return x == rhs.x && y == rhs.y; }

        /// <summary>Returns true if the half2 is equal to a given half2, false otherwise.</summary>
        /// <param name="o">Right hand side argument to compare equality with.</param>
        /// <returns>The result of the equality comparison.</returns>
        public readonly override bool Equals(object o) { return o is half2 converted && Equals(converted); }
